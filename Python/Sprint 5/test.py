...
class TestCliente(unittest.TestCase):
    ...
    def test_agregar_tarjeta_debito_cliente_black(self):
        ...
        self.assertIn(tarjeta_debito, self.black_customer.tarjetas_debito)
        ...
        self.assertEqual(len(self.black_customer.tarjetas_debito), 5)  # Solo se permiten 5
    ...
    def test_agregar_tarjeta_credito_cliente_black(self):
        ...
        self.assertIn(tarjeta_credito, self.black_customer.tarjetas_credito)
        ...
        self.assertEqual(len(self.black_customer.tarjetas_credito), 10)  # Solo se permiten 10
    ...
    def test_agregar_tarjeta_debito_cliente_gold(self):
        ...
        self.assertIn(tarjeta_debito, self.gold_customer.tarjetas_debito)
        self.assertNotIn(tarjeta_debito, self.gold_customer.tarjetas_credito)
    ...
    def test_agregar_tarjeta_credito_cliente_gold(self):
        ...
        self.assertIn(tarjeta_credito, self.gold_customer.tarjetas_credito)
        self.assertNotIn(tarjeta_credito, self.gold_customer.tarjetas_debito)
        ...
        self.assertEqual(len(self.gold_customer.tarjetas_debito), 1)  # Solo se permite 1
        ...
        self.assertEqual(len(self.gold_customer.tarjetas_credito), 5)  # Solo se permiten 5
    ...
    def test_agregar_cuenta_gold(self):
        ...
        self.assertIn(cuenta_ca, self.gold_customer.cajas_ahorro)
        ...
        self.assertIn(cuenta_ci_pesos, self.gold_customer.cuentas_corrientes)
        self.assertEqual(self.gold_customer.cargo_mensual, 0)
        ...
        self.assertIn(cuenta_ci_dolares, self.gold_customer.cuentas_corrientes)
        ...
        self.assertIn(cuenta_inversion, self.gold_customer.cuentas_inversion)
    ...
    def test_agregar_cuenta_black(self):
        ...
        self.assertIn(cuenta_ca_dolares, self.black_customer.cajas_ahorro_dolares)
        self.assertEqual(self.black_customer.cargo_mensual, 0)

        # Caso 2: Agregar una cuenta de cuenta corriente en dólares
        cuenta_ci_pesos = CuentaCorrientePesos()
        self.black_customer.agregar_cuenta(cuenta_ci_pesos, 10)
        self.assertIn(cuenta_ci_pesos, self.black_customer.cuentas_corrientes)
        self.assertEqual(self.black_customer.cargo_mensual, 0)

        # Caso 3: Agregar una cuenta de cuenta corriente en dólares
        cuenta_ci_dolares = CuentaCorrienteDolares()
        self.black_customer.agregar_cuenta(cuenta_ci_dolares, 10)
        self.assertIn(cuenta_ci_dolares, self.black_customer.cuentas_corrientes)
        ...
        self.assertIn(cuenta_ca_pesos, self.black_customer.cajas_ahorro_pesos)
        self.assertEqual(self.black_customer.cargo_mensual, 0)

        # Caso 5: Agregar una cuenta de inversión
        cuenta_inversion = CuentaInversion()
        self.black_customer.agregar_cuenta(cuenta_inversion, 10)
        self.assertIn(cuenta_inversion, self.black_customer.cuentas_inversion)
        self.assertEqual(self.black_customer.cargo_mensual, 0)
